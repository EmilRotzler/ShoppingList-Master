...
public class clearDialog extends DialogFragment {
    ...
    clearDialog.OnPositiveListener mCallback;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            mCallback = (clearDialog.OnPositiveListener) activity;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        alert.setMessage("Do you want to clear all products from the list?");
